 ...
 const CartPage = () => {
  ...
  return (
    <section className='cart page min-h-[50vh] w-full flex justify-center px-3 md:px-0 text-sm '>
        ...
        {cart.length < 1 ? <div className='flex gap-8 flex-col'>
            <div className="flex gap-[20%]">
            <div className='w-1/4'><LinkComponent name='Shop now!' href='/' bg='bg-green-600' icon = {<ArrowLeft/>} iconPosition='left'/> </div>
            <h1 className='text-center text-3xl'>Your Cart is Empty</h1>
            </div>
                
            <div className="empty-cart-img w-full flex justify-center items-center">
                <Image
                    src={'/empty-cart.svg'}
                    alt='empty cart'
                    width={300}
